    ...
    <b-form @submit.prevent="submit" id="form">
      <b-container class="py-3 px-0 text-left" v-if="questionnaire.sections">
        <div class="text-left d-flex justify-content-between">
          ...
          <div>
            <span class="text-dark-green score"
              ><span class="text-muted fs14">Your score </span>
              {{ current_score }} / {{ totalscore }}</span
            >
            <br />
            <vue-countdown-timer
        ...
        <div>
          <div class="mb-4 border-bottom">
            ...
            <div class="shadow rounded p-4 position-relative">
              <b-form-group
                :label="
              ...
              >
                <div
                  class="mb-3"
                  v-if="
                    questionnaire.sections[section].questions[question_num].hint
                  "
                >
