      ...
      <div class="pb-5 pt-sm-4">
        ...
        >
          ...
          <div class="mb-4 position-relative media border rounded">
            ...
            >
              <div
                class="bg-lighter-green fs12 px-3 py-1 rounded cursor-pointer"
              >
                Edit
              </div>
            </FeedUpload>
          ...
          <b-row class="justify-content-center">
            <b-col sm="8" class="px-0">
              ...
              <div v-if="showFeeds">
                  ...
                  <div class="feed-content">
                    ...
                    >
                      ...
                      <div v-if="feed.media || feed.publicId">
                        <div
                          class="mb-4 position-relative w-100 media bg-white"
                        >
                          <b-icon
                            v-if="toggleOn == index"
                            icon="heart-fill"
                ...
                <div v-else class="text-center p-3 p-sm-4">
                  No feed Available
                </div>
              </div>
