...
.calculator .calculator-border .calculator-display {
  ...
  -webkit-box-shadow: 1rem 1rem 0.5rem var(--lighter-green);
  box-shadow: 0.1rem 0.1rem 0.5rem var(--lighter-green);
}
...
.calculator .calculator-border .calculator-items .calculator-item {
  ...
  -webkit-box-shadow: 0.1rem 0.1rem 0.3rem rgb(54, 112, 98);
  box-shadow: 0.1rem 0.1rem 0.3rem rgb(54, 112, 98);
  transition: all 0.1s;
...
.calculator .calculator-border .calculator-items .calculator-item:hover {
  color: #f1f5f7;
  -webkit-box-shadow: 0.3rem 0.3rem 0.5rem var(--lighter-green);
  box-shadow: 0.3rem 0.3rem 0.5rem var(--lighter-green);
}
