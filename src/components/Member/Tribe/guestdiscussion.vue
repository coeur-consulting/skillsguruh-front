                ...
                <div v-if="posts" v-chat-scroll>
                  ...
                  >
                    ...
                    >
                      ...
                      <div
                        v-for="(reply,
                        index) in item.discussionmessagecomment.slice(0, 2)"
                        :key="index"
    ...
    <b-modal no-close-on-backdrop id="share" hide-footer centered size="lg">
      <div class="p-2 text-center">
        ...
        <ShareNetwork
          ...
          :description="
            `I just joined a discussion, ${discussion.name.toUpperCase()}  on Nzukoor and I’d like to hear your thoughts. Lets discuss!`
          "
          quote="Nzukoor"
