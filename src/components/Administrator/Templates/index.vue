        ...
        <b-col class="mb-5 mb-sm-0">
          ...
          <div class="shadow bg-white">
            ...
            <div class="">
              ...
              <div class="p-3 d-flex justify-content-between"  v-if="filter.length > 10">
...
export default {
  ...
  methods: {
    ...
    edit(id) {
      this.$router.push(`/administrator/questionnaire/edit/${id}`);
    },
    view(id) {
      this.$router.push(`/administrator/questionnaire/view/${id}`);
    },
