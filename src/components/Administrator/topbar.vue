  ...
  <div id="topbar">
    ...
    <div class="d-flex align-items-center d-sm-none">
      <div class="mr-3">
        <PushRotate :closeOnNavigation="true" width="250">
          <div class="logo d-flex align-items-center">
            <div style="width: 40px; height: 40px" class="mr-2">
              <b-img fluid :src="$store.getters.admin.org_profile"></b-img>
            </div>
        ...
        <router-link to="/administrator/modules">
          <div class="side_item">
            <b-icon
              icon="card-list"
              font-scale="1.1"
      ...
      <div class="org_name fs14" @click="$router.push('/administrator')">
        {{ this.$store.getters.admin.org_name }}
      </div>
    </div>
    ...
    <div class="d-flex align-items-center">
      ...
      >
       ...
       <mail-icon size="1.5x" class="custom-class mr-4 text-muted cursor-pointer" id="inbox"></mail-icon>
