          ...
          <div class="shadow-sm bg-white py-4 rounded">
            <div class="main_content text-left">
              ...
              <div class="content p-3 pt-4 pb-3">
                <div class="top_dis d-flex align-items-center mb-2">
                  ...
                  <div class="text-left next_dis">
                    ...
                    ><br />
                    <span class="asked"> Created 2 months ago</span>
                  </div>
                </div>
                <div class="top_dis d-flex align-items-center">
                  <div
                  ...
                  <div class="text-left next_dis">
                    <div class="main_text">
                      ...
                      Quidem sit fuga totam repellendus ullam rerum provident
                      harum, sunt commodi. Voluptatibus! Lorem ipsum dolor sit
                      amet consectetur adipisicing elit. Quidem sit fuga totam
                      repellendus ullam rerum provident harum, sunt commodi.
                      Voluptatibus!
                    </div>
                  </div>
                </div>
                ...
                <div class="bottom_bar mb-3">
                  <h6><b-avatar size="sm" class="mr-1"></b-avatar> John Doe</h6>
                  <p class="fs14">
                    Lorem ipsum dolor, sit amet consectetur adipisicing elit.
                    Vel, quos? Pariatur deleniti veritatis iure adipisci beatae
                    magni nihil quasi qui.
                  </p>
                  <div class="text-right">
                    <span>Mon 11:30 pm</span>
                  </div>
                </div>
                <div class="bottom_bar mb-3">
                  <h6><b-avatar size="sm" class="mr-1"></b-avatar> Jane Doe</h6>
                  <p class="fs14">
                    Lorem ipsum dolor, sit amet consectetur adipisicing elit.
                    Vel, quos? Pariatur deleniti veritatis iure adipisci beatae
                    magni nihil quasi qui.
              ...
              <div class="p-4">
                ...
                ></b-textarea>
                <div class="text-right">
                  <b-button variant="dark-green">Post</b-button>
                </div>
              </div>
            </div>
          </div>
