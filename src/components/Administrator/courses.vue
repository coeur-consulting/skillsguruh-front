    ...
    >
      <div class="p-2 text-center">
        ...
        <ShareNetwork
          ...
          :description="
            `I created a course titled,  *${course.title}*, on SkillsGuruh. Check it out here`
          "
          quote="SkillsGuruh"
                  ...
                  >
                    ...
                    > -->
                        <b-dropdown-item
                          ...
                          @click="
                            $router.push(
                              `/administrator/modules/${course.id}?showing=${course.title}`
                            )
                          "
