<template>
  <div>
    <b-container fluid class="px-3 py-0">
      <b-row>
        <b-col md="9">
                    ...
                    <transition-group type="transition" :name="'flip-list'">
                      ...
                      >
                        ...
                        <div v-if="question.showQuestion">
                          ...
                          <b-form-row class="" v-if="options.grading">
                            <b-col sm="3">
        ...
        <b-col md="3" class="bg-white right_box py-4 px-1 text-center">
          <div class="mb-5">
            ...
            <hr />
            <div v-if="options.time" class="mb-5 text-left">
            ...
            <div>
              ...
              >
              <b-button variant="dark-green" @click="save" block
...
export default {
  ...
  mounted() {
    ...
    this.questionnaire.options = this.$props.options;
  },
  computed: {
    dragOptions() {
      return {
